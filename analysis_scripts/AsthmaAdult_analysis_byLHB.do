...
foreach lhb of local lhbs {
	...
	log using "analysis_logs/AsthmaAdult_analysis_`lhb'", smcl replace
	...
	log close
	translate "analysis_logs/AsthmaAdult_analysis_`lhb'.smcl" ///
			  "outputs/AsthmaAdult_analysis_`lhb'.pdf"
	
	//== CLUSTER ANALYSIS ======================================================
	
	log using "analysis_logs/AsthmaAdult_analysis_`lhb'_cluster", smcl replace
	...
	bysort clustername: tab1 copd bronchiectasis chd diabetes heart_failure hypertension ///
							 lung_cancer pain stroke osteoporosis obese eczema atopy ///
							 nasal_polyps reflux hayfever family_history_of_asthma ///
							 allergic_rhinitis serious_mental_illness anxiety anxiety2yr ///
	...
	log close
	translate "analysis_logs/AsthmaAdult_analysis_`lhb'_cluster.smcl" ///
			  "outputs/AsthmaAdult_analysis_`lhb'_cluster.pdf"
