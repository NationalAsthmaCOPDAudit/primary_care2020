...
foreach binaryvar of local binaryvars {
	...
	drop gender wimd_quintile smokstat sh_smoke asthmaexacs_cat gp_exacerbations_cat therapy_type
...
foreach level of local levels {
	...
	export delimited "outputs/AnalysedPrimaryCareAudit_AsthmaChild_6-18_`level'_FemaleAge", replace
