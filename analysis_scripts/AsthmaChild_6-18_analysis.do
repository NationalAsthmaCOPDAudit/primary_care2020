...
/* create log file */
capture log close
log using analysis_logs/AsthmaChild_6-18_analysis, smcl replace
...
log close
translate analysis_logs/AsthmaChild_6-18_analysis.smcl outputs/AsthmaChild_6-18_analysis.pdf
